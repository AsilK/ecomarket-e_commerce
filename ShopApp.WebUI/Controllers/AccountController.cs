...
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Register(RegisterModel model)
    {
        ...
        if (result.Succeeded)
        {
            ...
            await _emailSender.SendEmailAsync(
                ...
                $"Lütfen email hesabınızı onaylamak için linke <a href='{baseUrl}{callbackUrl}'>tıklayınız.</a>");
    ...
    public async Task<IActionResult> Login(LoginModel model)
    {
        ...
        var result = await _signInManager.PasswordSignInAsync(user, model.Password ?? string.Empty, true, false);
    ...
    public async Task<IActionResult> ForgotPassword(string Email)
    {
        ...
        await _emailSender.SendEmailAsync(
            Email, 
            "Reset Password", 
            $"Parolanızı yenilemek için linke <a href='{baseUrl}{callbackUrl}'>tıklayınız.</a>");
